...
\begin{center}
\resizebox{.6\columnwidth}{!}{\includegraphics{rcu/design/ExpRCUFlow}}
\end{center}
...
\begin{center}
\resizebox{.6\columnwidth}{!}{\includegraphics{rcu/design/ExpSchedFlow}}
\end{center}
...
\begin{center}
\resizebox{\columnwidth}{!}{\includegraphics{rcu/design/Funnel0}}
\end{center}
...
\begin{center}
\resizebox{\columnwidth}{!}{\includegraphics{rcu/design/Funnel1}}
\end{center}
...
\begin{center}
\resizebox{\columnwidth}{!}{\includegraphics{rcu/design/Funnel2}}
\end{center}
...
\begin{center}
\resizebox{\columnwidth}{!}{\includegraphics{rcu/design/Funnel3}}
\end{center}
...
\begin{center}
\resizebox{\columnwidth}{!}{\includegraphics{rcu/design/Funnel4}}
\end{center}
...
\begin{center}
\resizebox{\columnwidth}{!}{\includegraphics{rcu/design/Funnel5}}
\end{center}
...
\begin{center}
\resizebox{\columnwidth}{!}{\includegraphics{rcu/design/Funnel6}}
\end{center}
...
\begin{center}
\resizebox{\columnwidth}{!}{\includegraphics{rcu/design/Funnel7}}
\end{center}
...
\begin{center}
\resizebox{\columnwidth}{!}{\includegraphics{rcu/design/Funnel8}}
\end{center}
