...
\label{sec:docs:Control dependencies}

\begin{Note}
  Pretty-printed \path{tools/memory-model/Documentation/control-dependencies.txt}.
\end{Note}
...
It is tempting to try to use control dependencies to enforce ordering on
