\section{Locking}
\label{sec:docs:Locking}

\begin{Note}
  Pretty-printed \path{tools/memory-model/Documentation/locking.txt}.
\end{Note}

\begin{Note}
  This section expands on
  \cref{sec:docs:recipes:Locking},
  focusing on locklessly accessing shared varibles that are
...
\hyperref[sec:docs:litmus-tests:Spin loops]{topic}
in \path{litmus-tests.txt}.
