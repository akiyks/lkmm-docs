...
\Dark	\tco{smp_mb__after_srcu_read_unlock} & F[after-srcu-read-unlock] \\
	...
	C macro  &  Events \\
	\cmidrule(r){1-1} \cmidrule(l){2-2}
\Dark	\tco{atomic_add} & R*[noreturn] ->rmw W*[noreturn] \\
\Dark	\tco{atomic_and} & \\ \Extraspace
	...
	C macro  &  Events \\
	\cmidrule(r){1-1} \cmidrule(l){2-2}
\Dark	\tco{atomic_add_return} & R*[mb] ->rmw W*[mb] \\
...
\Dark	\tco{atomic_add_return_acquire} & R*[acquire] ->rmw W*[acquire] \\
...
\Dark	\tco{atomic_add_negative_acquire} & \\ \Extraspace
	\tco{atomic_add_return_release} & R*[release] ->rmw W*[release] \\
	...
	C macro  &  Events \\
	\cmidrule(r){1-1} \cmidrule(l){2-2}
\Dark	\tco{atomic_cmpxchg} & On success: R*[mb] ->rmw W*[mb]  \\
\Dark                        & On failure: R*[mb] \\
\Dark	\tco{cmpxchg} & \\
\Dark   \tco{atomic_add_unless} & \\ \Extraspace
	\tco{atomic_cmpxchg_relaxed} & On success: R*[once] ->rmw W*[once] \\
	                             & On failure: R*[once] \\ \Extraspace
\Dark	\tco{atomic_cmpxchg_acquire} & On success: R*[acquire] ->rmw W*[acquire] \\
\Dark	                             & On failure: R*[acquire] \\ \Extraspace
	\tco{atomic_cmpxchg_release} & On success: R*[release] ->rmw W*[release] \\
	                             & On failure: R*[release] \\ \Extraspace
