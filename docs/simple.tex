...
\label{sec:docs:Quick and simple guide to LKMM}

\begin{Note}
  Pretty-printed \path{tools/memory-model/Documentation/simple.txt}.
\end{Note}
...
variable will be seen by all CPUs as having happened before any code
...
file to peel off the next layer of the memory-ordering onion.
