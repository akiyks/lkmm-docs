\section{Recipes}
\label{sec:docs:Recipes}

\begin{Note}
  Pretty-printed \path{tools/memory-model/Documentation/recipes.txt}.
\end{Note}
...
\label{sec:docs:recipes:Locking}

\begin{Note}
  \Cref{sec:docs:Locking} expands on this section, providing more detail on
...
The \co{init_stack_slab()} function in \path{lib/stackdepot.c} (as of v5.7)
uses release-acquire in this way to safely initialize of a slab of the stack.
