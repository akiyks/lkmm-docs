...
\usepackage[tocskip=0pt]{parskip}
...
% Silence warning of "LaTeX Warning: Command \showhyphens   has changed.",
% observed with LaTeX2e <2025-06-01> and microtype v3.2.
% This will be fixed in a later release of microtype.
\RequirePackage[save]{silence}
\WarningFilter[showhyphens]{latex}{Command \showhyphens}
\IfPackageAtLeastTF{microtype}{2025/03/01}{}{
  \ActivateWarningFilters[showhyphens]
}
...
% work around a wack-a-mole behavior of cleveref as of LaTeX2e <2025-06-01>
\IfPackageAtLeastTF{amsmath}{2025/01/19}{
\input{hotfix-cleveref.ltx}
}{}
